...
public class UserTypeManagerImpl implements UserTypeManager {
    ...
    private void initUserTypeTableInfo() {
        ...
        newer.put("description", new JavaBeanColumnAdapter("desc", "java.lang.String"));
        newer.put("userMetadataXML", new JavaBeanColumnAdapter("userMetadataXML", "java.lang.String"));

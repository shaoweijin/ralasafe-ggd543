...
/**
 * 为{@link Application }类提供管理功能的接口
 */
public interface ApplicationManager {

    public abstract void addApplication(Locale locale, Application app) throws EntityExistException;
    ...
    public abstract void addApplicationUserType(Locale locale, String appName, UserType userType);
     ...
     * @param userType
     */
    public abstract void updateApplicatonUserType(String appName, UserType userType);
     ...
     * @param userTypeName
     */
    public abstract void deleteApplicationUserType(String appName, String userTypeName);
}

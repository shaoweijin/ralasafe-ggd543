...
public class EntitleManagerImpl implements EntitleManager {
    ...
    private void initDecision() {
        ...
        newer.setColumnNames(new String[]{"id", "privilegeId", "userCategoryId", "businessDataId", "effect", "denyReason"});
        newer.setIdColumnNames(new String[]{"id"});
        newer.setUniqueColumnNames(new String[]{"privilegeId", "userCategoryId", "businessDataId"});
        newer.setMappingClass(DecisionEntitlement.class.getName());
        newer.setColumnJavaBeanAttributeClazz(new String[]{"int", "int", "int", "int", "java.lang.String", "java.lang.String"});
        newer.setId(DBPower.getTableId(null, newer.getTableName()));

        decisionTable = newer.getTable();
        decisionSelector = new TableSelectorImpl();
        decisionSelector.setObjectNewer(new JavaBeanObjectNewer(newer.getMappingClass()));
    ...
    private void initQuery() {
        ...
        newer.setColumnNames(new String[]{"id", "privilegeId", "userCategoryId", "queryId", "description"});
        newer.setIdColumnNames(new String[]{"id"});
        newer.setUniqueColumnNames(new String[]{"privilegeId", "userCategoryId"});
        newer.setMappingClass(QueryEntitlement.class.getName());
        newer.put("id", new JavaBeanColumnAdapter("id", "int"));
        newer.put("privilegeId", new JavaBeanColumnAdapter("privilegeId", "int"));
        newer.put("userCategoryId", new JavaBeanColumnAdapter("userCategoryId", "int"));
    ...
    public Collection getDecisionEntitlements(int pvlgId) {
        ...
        Collection entitlements = decisionSelector.select(decisionPvlgIdCdtn, hint);

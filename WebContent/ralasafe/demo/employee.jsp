...
<div class="smallContainer">
    ...
    <table class="ralaTable">
        ...
        <tr>
            <td><%=(employee.getName() == null ? "" : employee.getName())%>
            </td>
            <td><%=(employee.getHireDate() == null ? "" : shortSdf.format(employee.getHireDate()))%>
            </td>
            <td><%=(employee.getCompanyName() == null ? "" : employee.getCompanyName())%>
            </td>
            <td><%=(employee.getDepartmentName() == null ? "" : employee.getDepartmentName())%>
            </td>
            <td><%=(employee.getIsManager() == 1 ? "YES" : "NO")%>
            </td>
        </tr>
            <%
			}

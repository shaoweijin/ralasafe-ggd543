...
%>
<p><font color="red"><%=URLDecoder.decode(denyMessage, "UTF-8")%>
</font></p>
<%
    }
%>
<%
    String _gotoPage = (String) session.getAttribute("gotoPage");
    String gotoPage = StringUtil.isEmpty(_gotoPage) ? "main.jsp" : _gotoPage;
%>

...
<%@page import="org.ralasafe.userType.UserType,org.ralasafe.util.I18N" %>
...
<head>
    ...
    <title><%=i18n.say("User_Metadata_Management")%>
    </title>
</head>
<body>
<%
    Collection userTypes = (Collection) request.getAttribute("userTypes");
...
<script language="javascript">
    function submitUserTypeForm() {
        var names = new Array(<%=buff.toString()%>);
...
<div class="smallContainer">
    <form action="userTypeInstall.rls" method="post" id="userTypeForm"
          ENCTYPE="multipart/form-data" onsubmit="return submitUserTypeForm()">
    ...
    <p>
        <a href="javascript:toggleExample()"><%=i18n.say("User_metadata_example")%>
        </a>
...
&lt;/user>
    ...
    <h1><%=i18n.say("User_metadata_list")%>
    </h1>
    <table class="ralaTable">
        ...
        <tr bgcolor="#F4F4F4">
            ...
            <td><a href="?op=view&name=<%=userType.getName()%>"><%=i18n.say("Detail")%>
            </a>
                <a href="javascript:ensureDelete('?op=delete&name=<%=userType.getName()%>');"><%=i18n.say("Delete")%>
                </a></td>
        </tr>
        <%
            }

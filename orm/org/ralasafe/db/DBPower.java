...
public class DBPower {
    ...
    public static void on(Map map) {
        ...
        log.info("**** Starting Ralasafe datasource ......");
        log.info("\t\tDirectory: " + baseDir);

        // startup datasource and register into dsnameMap
    ...
    public static Connection[] getConnections(int[] tableIds)            throws DBLevelException {
